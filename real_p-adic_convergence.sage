...
K = Qp(p, prec = 50000, type = 'capped-rel', print_mode = 'series')
...
def real_approximation_BrI_Sqrt(D,lim):
	if K(D).is_square()==1:
		[exp,prep,per]=detect_period_BrowkinI_Sqrt(D,lim)
		[A,B]=convergents_cf(exp,lim)
		print("The 10th convergent is::",RR(A[10]/B[10]))

		if lim>100:
			print("The 100th convergent is:",RR(A[100]/B[100]))
		if lim>1000:
			print("The 1000th convergent is:",RR(A[1000]/B[1000]))
		if lim>5000:
			print("The 5000th convergent is:",RR(A[5000]/B[5000]))
		if lim>10000:
			print("The 10000th convergent is:",RR(A[10000]/B[10000]))
...
def real_approximation_BrII_Sqrt(D,lim):
	if K(D).is_square()==1:
		[exp,prep,per]=detect_period_BrowkinII_Sqrt(D,lim)
		[A,B]=convergents_cf(exp,lim)
		print("The 10th convergent is::",RR(A[10]/B[10]))
...
def real_approximation_New_Sqrt(D,lim):
	if K(D).is_square()==1:
		[exp,prep,per]=detect_period_New_Sqrt(D,lim)
		print(len(exp))
		[A,B]=convergents_cf(exp,lim)
		print("The 10th convergent is::",RR(A[10]/B[10]))
...
def print_nonperiodic_real_limit_BrI(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
	...
	for i in range(len(roots)):
		...
		if [x[1],x[2]]==[0,0]:
			...
			periodic_roots.append(roots[i])
			number_periodic=number_periodic+1
			[A,B]=convergents_cf(x[0],lim)
			print(roots[i], RR(floor((A[lim-1]/B[lim-1])*10000)/10000)^2)

	return 0



def print_periodic_real_limit_BrI(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
	...
	for i in range(len(roots)):
		...
		if [x[1],x[2]]!=[0,0]:
			...
			periodic_roots.append(roots[i])
			number_periodic=number_periodic+1
			BrIexp=BrowkinI_cf_Sqrt(roots[i],lim)
			[A,B]=convergents_cf(BrIexp,lim)
			print(roots[i], RR(floor((A[lim-1]/B[lim-1])*10000)/10000)^2)
...
def print_nonperiodic_real_limit_BrII(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
...
def print_periodic_real_limit_BrII(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
	...
	for i in range(len(roots)):
		...
		if [x[1],x[2]]!=[0,0]:
			...
			periodic_roots.append(roots[i])
			number_periodic=number_periodic+1
			BrIIexp=BrowkinII_cf_Sqrt(roots[i],lim)
			[A,B]=convergents_cf(BrIIexp,lim)
			print(roots[i], RR(floor((A[lim-1]/B[lim-1])*10000)/10000)^2)
...
def print_nonperiodic_real_limit_New(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
...
def print_periodic_real_limit_New(roof,lim):
	roots=[]
	for i in range(1,roof+1):
		if K(i).is_square()==True and sqrt(i)!=floor(sqrt(i)) and K(i).valuation()==0:
			roots.append(i)
	...
	for i in range(len(roots)):
		...
		if [x[1],x[2]]!=[0,0]:
			...
			periodic_roots.append(roots[i])
			number_periodic=number_periodic+1
			Newexp=New_cf_Sqrt(roots[i],lim)
			[A,B]=convergents_cf(Newexp,lim)
			print(roots[i], RR(floor((A[lim-1]/B[lim-1])*10000)/10000)^2)
